    ...
    <div>
      ...
      <div clssName="information">
        <p className="title">
          ...
          <a className="aTag" href={url} target="_blank" rel="noreferrer">
            {title}
          </a>
        </p>
        <hr className="hr" />
      ...
      <div className="Container">
        ...
        <div className="buttonContainer">
          <button className="button is-rounded first" onClick={openModal}>
            도네이션 차트
          </button>
      ...
      <div>
        <Modal open={modalOpen} close={closeModal} header="Video Division">
          <img
            className="contents"
